      ...
      <div className="tablewrap">
        <table className="cmp">
          ...
          <tbody>
            ...
            <tr className="em"><th scope="row">목표·보상</th><td>실적용 가능한 업무 솔루션<br />AI 역량 강화</td><td>수료</td><td><b><span style={{ fontWeight: "normal" }}>수상</span></b>(태블릿·해외벤치마킹·포상휴가·상품권 등)</td></tr>
