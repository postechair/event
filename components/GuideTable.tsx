  ...
  return (
    <section className="sec alt" id="compare" data-screen-label="선택 가이드 · 비교표형">
      ...
      <div className="tablewrap">
        <table className="cmp">
          <thead><tr>
            ...
            <th scope="col"><span className="cn">②</span><span className="ct">AX 부트캠프(고급교육)</span></th>
          ...
          <tbody>
            ...
            <tr className="em"><th scope="row">목표·보상</th><td>실적용 가능한 업무 솔루션<br />AI 역량 강화</td><td>수료 + 현업 연계</td><td>평가 후 성적에 따라 시상</td></tr>
      ...
      <div className="chiprow">
        ...
        <span className="chip">꾸준히 함께 성장 → ① Working Group</span><span className="chip">집중·몰입·체계적 → ② AX 부트캠프(고급교육)</span><span className="chip">시간 제약없이 자유롭게 참여 → ③ AX 공모전</span>
      </div>
      </div>
    </section>
  );
