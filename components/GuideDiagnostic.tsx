      ...
      <div className="flow">
        ...
        <div className="q" id="diag-q2">
          ...
          <div className="branches">
            ...
            <div className="branch"><button type="button" className={ansCls(1, 1)} aria-pressed={sel[1] === 1} onClick={() => pick(1, 1)}>3일 집중 교육이면 가능해요</button><span className="arrow">→</span><a className={resCls(1, 1)} aria-current={sel[1] === 1 ? "true" : undefined} href="#pg-edu">② 고급교육</a></div>
        ...
        <div className="q" id="diag-q3">
          ...
          <div className="branches">
            ...
            <div className="branch"><button type="button" className={ansCls(2, 1)} aria-pressed={sel[2] === 1} onClick={() => pick(2, 1)}>체계적으로 배우고 수료·인증 획득</button><span className="arrow">→</span><a className={resCls(2, 1)} aria-current={sel[2] === 1 ? "true" : undefined} href="#pg-edu">② 고급교육</a></div>
