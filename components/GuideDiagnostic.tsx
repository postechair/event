    ...
    <section className="sec" id="guide" data-screen-label="선택 가이드 · 진단형">
      ...
      <div className="flow">
        <div className="q" id="diag-q1">
          <div className="qnode"><div className="qnum">Q1</div><div className="qtext"><span style={{ color: "var(--primary)" }}>AI를 활용하여 업무 효율을 높이거나 업무를 자동화하는 등 AX 경험(또는 산출물)</span>이 있나요?<span className="note">코드·앱·업무 자동화·문서 등</span></div></div>
          <div className="branches">
            <div className="branch"><button type="button" className={ansCls(0, 0)} aria-pressed={sel[0] === 0} onClick={() => pick(0, 0)}>네, 있어요</button><span className="arrow">→</span><a className={resCls(0, 0)} aria-current={sel[0] === 0 ? "true" : undefined} href="#pg-comp">③ AX 공모전으로 바로 출품</a></div>
