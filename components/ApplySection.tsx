    ...
    <section className="sec alt" id="pg-apply" data-screen-label="신청 · 일정 · 문의">
      ...
      <div className="g3">
        <div className="speccard" style={{ padding: "15px 16px" }}>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.6, color: "var(--fg-neutral)" }}><b style={{ color: "var(--fg-strong)" }}>AIR센터에 참여 의사를 전달해주세요</b>. 참여 가능 상황 및 참여에 의해 달성하고자 하는 주제에 대해 충분히 의견을 나눈 뒤 참여를 결정하시면 됩니다.<br /><br />E: postech-air@postech.ac.kr<br />P: 054-279-3501</div>
        </div>
        <div className="speccard" style={{ padding: "15px 16px" }}>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.6, color: "var(--fg-neutral)" }}><b style={{ color: "var(--fg-strong)" }}>사전 수요조사 설문</b><b>에 응답해주세요.</b> 참여 의사와 가능 일정을 받아 차수를 편성합니다.<div style={{ marginTop: 12 }}>Link : <a href="https://forms.cloud.microsoft/r/hfkNYYATZj" target="_blank" rel="noopener">[사전수요조사]</a></div></div>
        </div>
        <div className="speccard" style={{ padding: "15px 16px" }}>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.6, color: "var(--fg-neutral)" }}>아래 <b style={{ color: "var(--fg-strong)" }}>온라인 신청서</b>를 작성해 제출하세요. 라이선스·컨설팅 지원이 필요하면 해당 신청서도 함께 제출합니다.
            <div className="cardlinks">
              <div><a href="https://forms.cloud.microsoft/Pages/ResponsePage.aspx?id=jOnzv8pcXEWtyF_ST8mQjfaXwssGAtFFnAAnJOxYAqlUMkRWSzQ4WlJBWFZEWDYzSEVITVcxTURESS4u" target="_blank" rel="noopener">참가신청서 ↗</a><span className="pill req">필수</span></div>
